...
#ARCH		?= $(SUBARCH)
ARCH            ?= arm64
CROSS_COMPILE   ?= /home/jay/toolchain/aarch64-linux-android-4.9/bin/aarch64-linux-android-
...
CC		= /home/jay/Downloads/proton-clang-master/bin/clang
CPP		= $(CC) -E
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
...
ifeq ($(cc-name),clang)
ifneq ($(CROSS_COMPILE),)
CLANG_TRIPLE	?= /home/jay/Downloads/proton-clang-master/bin/aarch64-linux-gnu-
